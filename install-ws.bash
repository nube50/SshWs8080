...
wget -q -O /etc/SSH-ws/websocket973.py raw.githubusercontent.com/ETH973/Sshws80/main/websocket973.py
...
screen -dmS ws_tunnel python3 /etc/SSH-ws/websocket973.py 80
